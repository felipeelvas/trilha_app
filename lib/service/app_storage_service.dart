...
//Métodos específicos para dados cadastrais
 ...
 Future<double> getDadosCadastraisSalario() async {
  ...
  Future<void> setConfiguracoesReceberPushNotifications(bool value) async {
    await _setBool(
        STORAGE_CHAVES.CHAVE_RECEBER_PUSH.toString(), value);
  }
  Future<bool> getConfiguracoesReceberPushNotifications() async {
    return _getBool(STORAGE_CHAVES.CHAVE_RECEBER_PUSH.toString());
  }
  ...
  //Métodos específicos para números aleatórios
  ...
  Future<void> setQtdCliques(int value) async {
    await _setInt(STORAGE_CHAVES.CHAVE_QTD_CLIQUES.toString(), value);
  }
  Future<int> getQtdCliques() async {
    return _getInt(STORAGE_CHAVES.CHAVE_QTD_CLIQUES.toString());
  }

// Métodos genéricos para manipulação do SharedPreferences
